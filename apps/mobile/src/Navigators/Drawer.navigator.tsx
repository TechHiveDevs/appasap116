...
import ListFollowersScreen from "../Entities/Followers/List.followers.screen";
import ShowFollowersScreen from "../Entities/Followers/Show.followers.screen";
  ...
  return (
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
            name="ListFollowersScreen"
            component={ListFollowersScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowFollowersScreen"
